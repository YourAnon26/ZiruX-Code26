...
def usage():
	...
	-T : Tor      --> defecto: OFF\n
	Ej: python3 code26.py -t www.ejemplo.com
	Ej: python3 code26.py -t www.ejemplo.com -p 8080
	Ej: python3 code26.py -t www.ejemplo.com -p 443 -c 40 -m post\n''' + Style.RESET_ALL)
	sys.exit()
...
def get_parameters():
	...
	optp = OptionParser(add_help_option=False,epilog="code26")	
...
if __name__ == '__main__':
	...
	print(Fore.YELLOW + Back.CYAN + Style.BRIGHT + " Iniciando... Code26 by ZiruX " + Style.RESET_ALL)
